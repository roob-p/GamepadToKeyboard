...
#AutoIt3Wrapper_Icon=icon.ico" Buttons"
...
if $pressed[$i]=True and not $keys[$i] Then
	...
	$timerT[$l][$i]=0
		...
		;$VibratePressed[$i]=False ;NO!
	for $u=0 to $VibrateBmaxN-1
		$VibratePressed[$u]=False
	next
...
case 0
	if ($VibrateButton[$i]=True and $VibrateButton_Modifier[$i]="NAA") or ($VibrateButton[$i]=True and $VibrateButton_Modifier[$i]=True) then
...
case 1
	if ($VibrateButton[$i]=True and $vibrateOn[$i]=0 and $vibratePressed[$i]=False) and ($VibrateButton_Modifier[$i]="NAA" or $VibrateButton_Modifier[$i]=True) Then
...
case 2
	if ($VibrateButton[$i]=True and $vibrateOn[$i]=0) and ($VibrateButton_Modifier[$i]="NAA" or $VibrateButton_Modifier[$i]=True) Then
	;if $VibrateButton[$i]=True and $vibrateOn[$i]=0 and $VibrateButton_Modifier[$i]=True then
		$TimerVibrate[$i]= timerInit()
		$vibrateOn[$i]=1
		VibrateAccumulator($i,$VibrateButton_LeftMotorStrength[$i], $VibrateButton_RightMotorStrength[$i])
	endif
